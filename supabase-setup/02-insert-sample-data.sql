...
INSERT INTO public.articles (
  title, content, excerpt, author, source_name, original_url, 
...
(
  ...
  'The central government unveiled a comprehensive digital infrastructure plan aimed at connecting rural areas with high-speed internet. The initiative, worth ₹50,000 crores, will focus on expanding fiber optic networks and 5G connectivity across tier-2 and tier-3 cities. Minister of Communications stated that this will bridge the digital divide and boost economic growth in rural areas.',
...
(
  ...
  'Environmental activists and opposition leaders have raised serious concerns about the rapid approval of mining projects in ecologically sensitive areas. The debate centers around balancing economic development with environmental protection. Congress leader criticized the government for prioritizing corporate interests over environmental safety.',
...
(
  ...
  'Latest economic indicators show India''s GDP growth has exceeded international forecasts, reinforcing the government''s economic policies. The growth is attributed to strong domestic demand and improved manufacturing output. Finance Ministry officials highlighted the success of recent reforms in driving economic expansion.',
